...
export const metadata = {
  ...
  description:
    "Expert drywall contractor in Calgary. Basement, ceiling & commercial installation. Licensed installer. Level 5 finish. Free quote.",
  keywords:
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <a href="tel:+18253653770" className={BTN + " text-lg px-8 py-4"}>
                  <svg
