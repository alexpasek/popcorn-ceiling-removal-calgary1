...
export default function Page(){ return(<>
  ...
  <section className="container-x py-6">
    <div className="card p-4 flex flex-wrap items-center gap-3"><div className="text-ink font-semibold">5 ★★★★★</div><div className="text-muted">Based on 80+ Calgary homeowner reviews</div></div>
