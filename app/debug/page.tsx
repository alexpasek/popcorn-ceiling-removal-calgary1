...
const routes = ['/', '/quote', '/get-quote', '/thank-you', '/services', '/services/popcorn-ceiling-removal-calgary', '/services/drywall-installation', '/services/wallpaper-removal', '/services/interior-painting', '/contact', '/faq', '/calgary/kensington'];
